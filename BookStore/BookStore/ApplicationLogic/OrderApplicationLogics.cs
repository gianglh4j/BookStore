...
namespace BookStore.ApplicationLogic
{
    ...
    public interface IOrderApplicationLogics
    {
        ...
        Task<OrderDTORes> updateOrderB(OrderDTO orderDTO);

        Task<IEnumerable<OrderB>> getOrders();

        Task<OrderDTORes> getOder(int bookId);
    ...
    public class OrderApplicationLogics : IOrderApplicationLogics
    {
        ...
        public async Task<OrderB> addOrder(OrderDTO orderDTO)
        {
           ...
           return  await _orderLogic.AddOrder(newOrderB, orderDTO.Detail);


        }

        public Task<OrderDTORes> getOder(int bookId)
        {
        ...
        public Task<OrderDTORes> updateOrderB(OrderDTO orderDTO)
        {
            throw new NotImplementedException();
        }
    }
